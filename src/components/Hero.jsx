...
const Hero = () => {
  return (
    <div className='text-[#fff]'>
      ...
      <div className="content text-center p-5 mt-[33.5%] font-odd md:w-[50%] md:m-auto md:mt-[17%]">
        ...
        <p className='opacity-[.5] pb-5 md:w-[50%] md:m-auto'>Sync up with people who share your interests. to develop the decentralized techologies of the future</p>
           <a href='/' className='py-[15px] px-[20px] block text-center w-[50%] m-auto bg-[#D2CF45]  text-[#070300] rounded-lg'><button className='font-semibold'>Register Today</button></a>
