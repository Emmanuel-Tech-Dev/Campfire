...
const Interest = () => {
  return (
    <div>
       ...
       <div className="content text-[#fff] -mt-[30%] md:-mt-[8%]">
        ...
        <a href='/' className='py-[15px] px-[20px] block text-center w-[50%] m-auto bg-[#D2CF45]  text-[#070300] rounded-lg md:w-[20%]'><button className='font-semibold'>Register Today</button></a>
