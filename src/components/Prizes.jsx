...
const Prizes = () => {
  return (
    <div>
        <div className="container text-[#fff] p-5 mt-8 m-auto max-w-[100%]">
            <div className="content text-center">
                <h1 className="text-2xl font-semibold p-3 md:text-4xl">Prizes</h1>
                <p className="opacity-[.5] sm:w-[50%] sm:m-auto">Send out your project now! the top performers will recieve honors, rewards, and glory</p>
            </div>

            <div className="prizes flex flex-wrap gap-x-20 justify-center items-center text-center md:max-w-[60%] md:m-auto md:gap-x-36">
